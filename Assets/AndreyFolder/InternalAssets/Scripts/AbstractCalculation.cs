...
public abstract class AbstractCalculation
{
    ...
    private float _groupSpawnСircleRadius;

    public AbstractCalculation(float spawnRadius, float colliderHitRadius, float groupSpawnСircleRadius, Transform player)
    {
        _spawnRadius = spawnRadius;
        _colliderHitRadius = colliderHitRadius;
        _groupSpawnСircleRadius = groupSpawnСircleRadius;
        _player = player;
    }
